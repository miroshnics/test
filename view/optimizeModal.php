    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <ul class="list-group">
          ...
          <li class="list-group-item">Добавить анимацию процесса подключения к БД, индикацию успешного или неуспешного соединения.</li>
          <li class="list-group-item">При получении содержимого таблиц помечать поле, являющееся ключом таблицы, и в форме редактирования записи запрещать редактировать это поле.</li>
